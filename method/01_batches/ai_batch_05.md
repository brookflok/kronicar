<!-- SOURCE: Acquisitions Incorporated (WotC 2019) | Chapter 3 — Backgrounds + Playing with Class (1/2) | source .md lines 1323-1737 -->
# Acq Inc — Ch3a: Backgrounds, Playing with Class (Barbarian-Cleric)

# Chapter 3: Player Options

![](img/book/AI/024-03-01.webp)
...
![The Corporate Barbarian](img/book/AI/027-03-04.webp)
...
*Seeming a "square peg" for the task at first glance, a barbarian might be an excellent choice, as they would destroy both the round hole and their own corners in the attempt to serve. It would be neat to see if this worked outside of an analogy.*— **K'thriss Drow'b**
### Bard
...
*Name a more iconic profession. I'll wait.*— **Omin Dran**
...
*Druids are natural-born leaders. We are beasts of war and shepherds of balance. People might underestimate you for your "simple" ways, but your teeth will find their flesh all the same. Not that I condone eating your party members, of course. Only when absolutely necessary.*— **Walnut Dankgrass**
#### Nature's Envoy
