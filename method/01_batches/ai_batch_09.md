<!-- SOURCE: Acquisitions Incorporated (WotC 2019) | Appendices B-E + Credits | source .md lines 2656-2861 -->
# Acq Inc — App B-E: Monsters, Vehicles, Orrery, Trinkets, Credits
...
![Agent Of The Noble Knife](img/book/AI/113-appendix-b-04.webp)
...
![Silver Sliver Zealot](img/book/AI/114-appendix-b-05.webp)
...
This section details the artifact known as the *Orrery of the Wanderer* and its six magic clockwork components, all of which are central to the adventure in *chapter 4*.
...
See the items page for the full list of *trinkets*.
