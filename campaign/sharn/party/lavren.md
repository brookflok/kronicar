...
## Sharn veze  [DM]
- **Kech Volaar** = kanonski Dhakaani clan (Wordbearers). **Sharn je sagrađen NAD drevnim Dhakaani gradom Ja'shaarat / Duur'shaarat**; ruševine su u **the Depths/UnderSharn**, a goblinoid zajednice u **Malleon's Gate** (Lower Dura) i **Khyber's Gate** (the Cogs). Vidi `summary_01` (historija grada) i `summary_02` (Malleon's Gate, Depths). Ovo je vrlo jak hook: ispod njenog grada doslovno leži ono za čim traga.
- **"drveno carstvo" = "drevno carstvo"** (staro **Dhakaani carstvo**). Riješeno (Josipa). To je ono o čemu sanjari i za čim traga.
- **Ghaal'dar vs Dhakaani napetost** [DM]: Lavren je **Ghaal'dar** (hobgoblini Darguuna pod Lhesh Haruuc), a **Kech Volaar** su čuvari čistog Dhakaani naslijeđa. Po `world/` brifingu, Kech Volaar su **optimisti** koji vjeruju da se "pali rod" (moderni goblini, uklj. Ghaal'dar) može povratiti, pa baš **šalju duur'kale među Ghaal'dar da ih uče muut i atcha** — Lavren je tačno meta tog programa. Vodi ih matrijarh **Tuura Dhakaan**; skupljaju izgubljene relikvije carstva (**Ur'taash** First Crown, **Guulen** Rod of Kings, **Ghaal'duur** Jhazaalin ratni rog). Battle Smith artificer + daashor tradicija (dhakaanski kovači nadmašuju i Cannith) savršeno pristaju.
